export declare module "@material/base" {
    export declare enum MDCStrings { }
    export declare enum MDCNumbers { }

    export declare class MDCFoundation<A> {
        static readonly cssClasses: any;

        static readonly strings: any;

        static readonly numbers: any;
    ...
    export declare class MDCComponent<A, F extends MDCFoundation<A>> {
        static attachTo(root: Element): MDCComponent<A, F>;
